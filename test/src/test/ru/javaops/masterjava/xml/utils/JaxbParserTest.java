...
//        JaxbParserTest.class.getResourceAsStream("/city.xml")
        Payload payload = JAXB_PARSER.unmarshal(
                Resources.getResource("src/main/resources/payload.xml").openStream());
    ...
    public void testCity() throws Exception {
        JAXBElement<CityType> cityElement = JAXB_PARSER.unmarshal(Resources.getResource("src/main/resources/city.xml").openStream());
