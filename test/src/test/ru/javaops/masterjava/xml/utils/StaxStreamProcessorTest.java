...
import ru.javaops.masterjava.xml.utils.stax.StaxStreamProcessor;
...
public class StaxStreamProcessorTest {
    ...
    public void readCities() throws Exception {
        try (StaxStreamProcessor processor = new StaxStreamProcessor(Resources.getResource("src/main/resources/payload.xml").openStream())) {
